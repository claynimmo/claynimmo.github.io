...
<table class="table-card">
  <tr>
    ...
    <br><br>
    <a href="projects/gamedev/games/rebirthoftheforsaken.html">More details</a>
    </td>
    <td class="table-card-side">
        <img src="projects/gamedev/games/images/rotf.png" alt="game icon" style="max-width: 100%; border-radius: 6px;">
    </td>
  </tr>
</table>
...
<table class="table-card">
  <tr>
    ...
    <br><br>
    <a href="projects/gamedev/packages/editortoolspackage.html">More details</a>
    </td>
  </tr>
</table>